...
// Comprehensive ML FAQs based on the provided content
const faqs = [
  // Introduction to Machine Learning FAQs
  {
    ...
    category: "general",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["machine learning", "AI", "fundamentals", "introduction"]),
    order: 1
  },
  {
    ...
    category: "general",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["AI", "machine learning", "deep learning", "hierarchy", "comparison"]),
    order: 2
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["supervised learning", "unsupervised learning", "reinforcement learning", "types", "algorithms"]),
    order: 3
  },
  {
    ...
    category: "practical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["training data", "testing data", "data split", "evaluation", "generalization"]),
    order: 4
  },
  {
    ...
    tags: JSON.stringify(["overfitting", "model complexity", "generalization", "regularization", "validation"]),
    order: 5
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["classification", "regression", "supervised learning", "prediction types", "algorithms"]),
    order: 6
  },
  {
    ...
    category: "practical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["feature engineering", "data preprocessing", "feature selection", "model performance", "data transformation"]),
    order: 7
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["cross-validation", "model evaluation", "K-fold", "validation", "hyperparameter tuning"]),
    order: 8
  },

  // Linear Regression & Gradient Descent FAQs
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["linear regression", "prediction", "supervised learning", "regression", "mathematics"]),
    order: 9
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["gradient descent", "optimization", "cost function", "learning rate", "algorithms"]),
    order: 10
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["cost function", "loss function", "error measurement", "optimization", "terminology"]),
    order: 11
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["learning rate", "hyperparameter", "optimization", "convergence", "gradient descent"]),
    order: 12
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["linear regression", "polynomial regression", "non-linear", "model complexity", "overfitting"]),
    order: 13
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["multicollinearity", "regression", "correlation", "VIF", "model interpretation"]),
    order: 14
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["batch gradient descent", "stochastic gradient descent", "mini-batch", "optimization", "algorithms"]),
    order: 15
  },

  // Classification & Logistic Regression FAQs
  {
    ...
    category: "general",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["classification", "supervised learning", "prediction", "categories", "algorithms"]),
    order: 16
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["logistic regression", "classification", "sigmoid function", "probability", "binary classification"]),
    order: 17
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["sigmoid function", "activation function", "logistic function", "probability", "mathematics"]),
    order: 18
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["confusion matrix", "evaluation metrics", "true positives", "false positives", "model assessment"]),
    order: 19
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["precision", "recall", "evaluation metrics", "classification", "trade-off"]),
    order: 20
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["ROC curve", "AUC", "evaluation metrics", "classification", "threshold"]),
    order: 21
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["one-vs-rest", "one-vs-one", "multi-class classification", "strategies", "algorithms"]),
    order: 22
  },

  // Neural Networks Fundamentals FAQs
  {
    ...
    category: "general",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["neural networks", "deep learning", "neurons", "layers", "brain-inspired"]),
    order: 23
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["perceptron", "neuron", "single layer", "linear separability", "history"]),
    order: 24
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["activation function", "non-linearity", "ReLU", "sigmoid", "neural networks"]),
    order: 25
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["backpropagation", "training", "gradient descent", "chain rule", "neural networks"]),
    order: 26
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["feedforward networks", "recurrent networks", "RNN", "sequential data", "architecture"]),
    order: 27
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["vanishing gradients", "exploding gradients", "deep learning", "training problems", "solutions"]),
    order: 28
  },
  {
    ...
    category: "advanced",
    difficulty: "CAPSTONE",
    tags: JSON.stringify(["universal approximation theorem", "theory", "neural networks", "function approximation", "mathematical foundations"]),
    order: 29
  },
  ...
  // Convolutional Neural Networks FAQs
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["CNN", "convolutional neural networks", "computer vision", "image processing", "deep learning"]),
    order: 30
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["convolution", "kernel", "filter", "feature extraction", "CNN operations"]),
    order: 31
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["pooling", "max pooling", "average pooling", "downsampling", "CNN"]),
    order: 32
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["CNN", "traditional networks", "architecture", "parameter sharing", "spatial structure"]),
    order: 33
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["padding", "CNN", "convolution", "border handling", "spatial dimensions"]),
    order: 34
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["stride", "CNN", "convolution", "downsampling", "spatial resolution"]),
    order: 35
  },
  {
    ...
    category: "advanced",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["CNN architectures", "LeNet", "AlexNet", "VGG", "ResNet", "history"]),
    order: 36
  },
  ...
  // Recurrent Neural Networks FAQs
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["RNN", "recurrent neural networks", "sequential data", "memory", "time series"]),
    order: 37
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["BPTT", "backpropagation through time", "RNN training", "gradients", "sequential learning"]),
    order: 38
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["LSTM", "long short-term memory", "gates", "cell state", "vanishing gradients"]),
    order: 39
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["LSTM", "GRU", "gated recurrent units", "comparison", "RNN architectures"]),
    order: 40
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["bidirectional RNN", "context", "future information", "NLP", "sequence processing"]),
    order: 41
  },
  {
    ...
    category: "practical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["RNN applications", "NLP", "language modeling", "machine translation", "text processing"]),
    order: 42
  }
];

async function getChapterByTitle(title) {
...
async function createFAQs() {
  console.log('Adding ML FAQs...');
  
  // Map chapter titles to their content
  const chapterMapping = {
    ...
    'Classification & Logistic Regression': [
      ...
      'What is the difference between One-vs-Rest and One-vs-One classification?'
    ],
    ...
    'Convolutional Neural Networks': [
      ...
      'What are the differences between CNN and traditional neural networks?',
      'What is padding in CNNs and why is it important?',
      'What is stride in CNNs?',
      'What are the famous CNN architectures and their contributions?'
    ],
  ...
  for (const faq of faqs) {
    try {
      ...
      let chapterId = null;
      for (const [chapterTitle, questions] of Object.entries(chapterMapping)) {
        if (questions.includes(faq.question)) {
      ...
      console.log(`✅ Added FAQ: ${result.question.substring(0, 50)}...`);
    } catch (error) {
