...
const faqs = [
  ...
  },
  {
    ...
    tags: JSON.stringify(["overfitting", "model complexity", "generalization", "validation"]),
    order: 5
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["classification", "regression", "supervised learning", "prediction types"]),
    order: 6
  },
  {
  ...
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["cross-validation", "model evaluation", "validation"]),
    order: 8
  },
  // Linear Regression & Gradient Descent
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["linear regression", "supervised learning", "regression"]),
    order: 9
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["gradient descent", "optimization", "cost function"]),
    order: 10
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["cost function", "loss function", "optimization"]),
    order: 11
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["learning rate", "gradient descent", "hyperparameter"]),
    order: 12
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["linear regression", "polynomial regression", "non-linear"]),
    order: 13
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["correlation", "regression", "statistics"]),
    order: 14
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["multicollinearity", "regression", "correlation"]),
    order: 15
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["batch gradient descent", "stochastic gradient descent", "optimization"]),
    order: 16
  },
  // Classification & Logistic Regression
  {
    ...
    category: "general",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["classification", "supervised learning", "prediction"]),
    order: 17
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["logistic regression", "classification", "sigmoid function"]),
    order: 18
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["sigmoid function", "activation function", "logistic regression"]),
    order: 19
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["confusion matrix", "evaluation metrics", "classification"]),
    order: 20
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["linear regression", "logistic regression", "classification", "regression"]),
    order: 21
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["precision", "recall", "evaluation metrics", "classification"]),
    order: 22
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["ROC curve", "AUC", "evaluation metrics", "classification"]),
    order: 23
  },
  {
  ...
  // Neural Networks Fundamentals
  {
    ...
    category: "general",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["neural networks", "deep learning", "AI"]),
    order: 25
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["perceptron", "neural networks", "history"]),
    order: 26
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["activation function", "neural networks", "non-linearity"]),
    order: 27
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["backpropagation", "neural networks", "training", "gradient descent"]),
    order: 28
  },
  {
    ...
    category: "technical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["feedforward networks", "recurrent networks", "RNN", "architecture"]),
    order: 29
  },
  {
    ...
    category: "technical",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["vanishing gradients", "exploding gradients", "deep learning", "training"]),
    order: 30
  },
  {
    ...
    category: "advanced",
    difficulty: "CAPSTONE",
    tags: JSON.stringify(["universal approximation theorem", "theory", "neural networks"]),
    order: 31
  },
  // Convolutional Neural Networks
  {
    ...
    difficulty: "PRACTICE",
    tags: JSON.stringify(["CNN", "convolutional neural networks", "computer vision", "deep learning"]),
    order: 32
  },
  {
    ...
    category: "deep-learning",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["convolution", "kernel", "filter", "CNN"]),
    order: 33
  },
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["pooling", "max pooling", "average pooling", "CNN"]),
    order: 34
  },
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["CNN", "traditional networks", "architecture", "computer vision"]),
    order: 35
  },
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["padding", "CNN", "convolution"]),
    order: 36
  },
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["stride", "CNN", "convolution"]),
    order: 37
  },
  {
  ...
  // Recurrent Neural Networks
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["RNN", "recurrent neural networks", "sequential data", "NLP"]),
    order: 39
  },
  {
    ...
    category: "deep-learning",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["BPTT", "backpropagation", "RNN", "training"]),
    order: 40
  },
  {
    ...
    category: "deep-learning",
    difficulty: "CHALLENGE",
    tags: JSON.stringify(["LSTM", "RNN", "vanishing gradients", "gates"]),
    order: 41
  },
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["LSTM", "GRU", "RNN", "comparison"]),
    order: 42
  },
  {
    ...
    category: "deep-learning",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["bidirectional RNN", "RNN", "NLP"]),
    order: 43
  },
  {
    ...
    category: "practical",
    difficulty: "PRACTICE",
    tags: JSON.stringify(["RNN applications", "NLP", "sequential data"]),
    order: 44
  }
];
